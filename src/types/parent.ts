...
export const getAttendanceColor = (status: string): string => {
  if (status === 'PRESENT') return 'bg-green-100 text-green-700 dark:bg-green-900/50 dark:text-green-300';
  if (status === 'ABSENT') return 'bg-red-100 text-red-700 dark:bg-red-900/50 dark:text-red-300';
  if (status === 'LATE') return 'bg-yellow-100 text-yellow-700 dark:bg-yellow-900/50 dark:text-yellow-300';
  return 'bg-gray-100 text-gray-700 dark:bg-gray-700 dark:text-gray-300';
};

export const getStatusColor = (status: string): string => {
  if (status === 'COMPLETED') return 'bg-green-100 text-green-700 dark:bg-green-900/50 dark:text-green-300';
  if (status === 'PENDING') return 'bg-yellow-100 text-yellow-700 dark:bg-yellow-900/50 dark:text-yellow-300';
