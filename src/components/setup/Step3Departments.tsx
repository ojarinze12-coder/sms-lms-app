  ...
  return (
    <div className="bg-white rounded-xl border p-6">
      <div className="flex items-center gap-3 mb-6">
        ...
        <div>
          <h2 className="text-xl font-bold">SSS Departments</h2>
      ...
      {existingDepartments.length > 0 ? (
        <div className="mb-6">
          <h3 className="font-medium mb-3">Current Departments:</h3>
          <div className="grid grid-cols-3 gap-3">
            {existingDepartments.map((dept) => (
              <div key={dept.id} className="p-3 bg-purple-50 rounded-lg">
      ...
      <div className="flex justify-between gap-3 mt-6 pt-6 border-t">
        ...
        <button
          onClick={onSave}
          disabled={submitting || (!existingDepartments.length && selectedDepts.length === 0)}
