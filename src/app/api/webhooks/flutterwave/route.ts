...
async function handleSuccessfulPayment(data: any) {
  ...
  } else if (txRef.startsWith('BILL_')) {
...
async function handleBillPayment(data: any, metadata: any) {
  ...
  console.log(`Processing Flutterwave bill payment: ${txRef}, amount: ${amount}, billId: ${billId}`);
  ...
  if (!billId) {
    console.error('No billId in metadata for bill payment:', txRef);
    return;
  }
  ...
  console.log(`Flutterwave bill payment ${txRef} completed successfully. Receipt: ${receiptNo}`);
