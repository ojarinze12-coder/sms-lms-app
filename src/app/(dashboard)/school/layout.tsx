...
const schoolNavItems = [
  {
    section: 'Main',
    items: [
      { label: 'Dashboard', href: '/school/dashboard', icon: 'grid' },
    ]
  },
  {
    section: 'AI Tools',
    items: [
      { label: 'AI Timetable', href: '/school/ai/timetable', icon: 'sparkles' },
      { label: 'AI Exam Generator', href: '/school/ai/exam', icon: 'sparkles' },
    ]
  },
  {
    section: 'Academics',
  ...
  {
    section: 'Virtual & Digital',
    items: [
      { label: 'Virtual Classes', href: '/sms/virtual-classes', icon: 'video' },
      { label: 'Content Library', href: '/lms/content', icon: 'folder' },
    ]
  },
  {
    section: 'People',
    items: [
      { label: 'Students', href: '/school/people/students', icon: 'users' },
      { label: 'Teachers', href: '/sms/teachers', icon: 'user-check' },
      { label: 'Non-Teaching Staff', href: '/sms/staff', icon: 'briefcase' },
      { label: 'Parents', href: '/sms/parents', icon: 'user-friends' },
      { label: 'User Mgmt', href: '/school/users', icon: 'user-circle' },
    ]
  },
  {
    section: 'HR & Payroll',
    items: [
      { label: 'HR Dashboard', href: '/sms/hr', icon: 'users' },
      { label: 'Leave Mgmt', href: '/sms/leaves', icon: 'calendar' },
      { label: 'Payroll', href: '/sms/payroll', icon: 'dollar' },
    ]
  },
  {
    section: 'Operations',
    items: [
      { label: 'Attendance', href: '/school/attendance', icon: 'check-circle' },
      { label: 'Finance', href: '/school/finance', icon: 'dollar' },
    ]
  },
  {
    section: 'Communication',
    items: [
      { label: 'Communication Hub', href: '/comm', icon: 'message' },
      { label: 'PTA Notices', href: '/comm/pta', icon: 'bell' },
      { label: 'Support', href: '/school/support', icon: 'help' },
    ]
  },
  {
    section: 'Reports & Settings',
    items: [
      { label: 'Reports Center', href: '/sms/reports', icon: 'bar-chart' },
...
const iconMap: Record<string, React.ReactNode> = {
  ...
  'user-check': <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z" /></svg>,
  'user-circle': <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M16 7a4 4 0 11-8 0 4 4 0 018 0zM12 14a7 7 0 00-7 7h14a7 7 0 00-7-7z" /></svg>,
  briefcase: <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M21 13.255A23.931 23.931 0 0112 15c-3.183 0-6.22-.62-9-1.745M16 6V4a2 2 0 00-2-2h-4a2 2 0 00-2 2v2m4 6h.01M5 20h14a2 2 0 002-2V8a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z" /></svg>,
  'user-friends': <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M17 20h5v-2a3 3 0 00-5.356-1.857M17 20H7m10 0v-2c0-.656-.126-1.283-.356-1.857M7 20H2v-2a3 3 0 015.356-1.857M7 20v-2c0-.656.126-1.283.356-1.857m0 0a5.002 5.002 0 019.288 0M15 7a3 3 0 11-6 0 3 3 0 016 0zm6 3a2 2 0 11-4 0 2 2 0 014 0zM7 10a2 2 0 11-4 0 2 2 0 014 0z" /></svg>,
