    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-gray-600">Learning Management System analytics and insights</p>
        </div>
          ...
          <CardContent className="pt-6">
            <div className="flex items-center gap-4">
              ...
              <div>
                ...
                <p className="text-xs text-green-600">{stats?.publishedCourses || 0} published</p>
              </div>
            </div>
          </CardContent>
        </Card>
          ...
          <CardContent className="pt-6">
            <div className="flex items-center gap-4">
              ...
              <div>
                ...
                <p className="text-xs text-gray-500">{stats?.totalEnrollments || 0} total enrollments</p>
              </div>
            </div>
          </CardContent>
        </Card>
          ...
          <CardContent className="pt-6">
            <div className="flex items-center gap-4">
              ...
              <div>
                ...
                <p className="text-xs text-gray-500">of {stats?.totalExams || 0} total</p>
              </div>
            </div>
          </CardContent>
        </Card>
          ...
          <CardContent className="pt-6">
            <div className="flex items-center gap-4">
              ...
              <div>
                ...
                <p className="text-xs text-green-600">{stats?.completionRate || 0}% completion</p>
              </div>
            </div>
          </CardContent>
        </Card>
                ...
                {topStudents.map((student, index) => (
                  <div key={student.id} className="flex items-center justify-between p-3 bg-gray-50 rounded-lg">
                    ...
                    <div className="text-right">
                      ...
                      <p className="text-xs text-gray-500">{student.coursesCompleted} courses</p>
                    </div>
                  </div>
                ))}
              </div>
