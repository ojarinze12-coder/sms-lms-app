    ...
    <div>
      <div className="flex items-center justify-between mb-8">
        <div>
          ...
          <p className="text-gray-500 mt-1">Manage all registered schools on the platform</p>
        </div>
        <Link
          href="/admin/tenants"
              ...
              <tr key={tenant.id} className="hover:bg-gray-50">
                ...
                <td className="px-6 py-4 text-sm text-gray-600">
                  <div className="flex gap-3">
                    <span><strong>{tenant._count?.students || 0}</strong> students</span>
                    <span><strong>{tenant._count?.teachers || 0}</strong> teachers</span>
                  </div>
                </td>
                <td className="px-6 py-4">
