  ...
  return (
    <div className="space-y-6">
      <div>
        ...
        <p className="text-gray-500">Overview of your school&apos;s performance</p>
      </div>
          ...
          <CardContent className="pt-6">
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-3xl font-bold">{analytics?.overview.students || 0}</p>
              </div>
          ...
          <CardContent className="pt-6">
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-3xl font-bold">{analytics?.overview.teachers || 0}</p>
              </div>
          ...
          <CardContent className="pt-6">
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-3xl font-bold">{analytics?.overview.classes || 0}</p>
              </div>
          ...
          <CardContent className="pt-6">
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-3xl font-bold">{analytics?.overview.exams || 0}</p>
              </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
        <Card>
          ...
          <CardContent>
            <p className="text-3xl font-bold text-green-600">{analytics?.attendance.presentRate || 0}%</p>
        ...
        <Card>
          ...
          <CardContent>
            <p className="text-3xl font-bold text-blue-600">{analytics?.fees.collectionRate || 0}%</p>
            <p className="text-xs text-gray-500 mt-1">
        ...
        <Card>
          ...
          <CardContent>
            <p className="text-3xl font-bold text-purple-600">{analytics?.exams.passRate || 0}%</p>
            <p className="text-xs text-gray-500 mt-1">
        ...
        <Card>
          ...
          <CardContent>
            <p className="text-3xl font-bold text-orange-600">{analytics?.exams.averageScore || 0}%</p>
            <p className="text-xs text-gray-500 mt-1">
              Across all exams
            </p>
          </CardContent>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <Card>
          <CardHeader className="pb-2">
            <CardTitle className="text-sm font-medium text-gray-500">Total Fees Generated</CardTitle>
          </CardHeader>
          <CardContent>
            <p className="text-2xl font-bold">{formatCurrency(analytics?.fees.totalGenerated || 0)}</p>
          </CardContent>
        </Card>
        <Card>
          <CardHeader className="pb-2">
          ...
          <CardContent>
            <p className="text-2xl font-bold text-green-600">{formatCurrency(analytics?.fees.totalCollected || 0)}</p>
          </CardContent>
        </Card>
        <Card>
          <CardHeader className="pb-2">
          ...
          <CardContent>
            <p className="text-2xl font-bold text-red-600">{formatCurrency(analytics?.fees.totalPending || 0)}</p>
          </CardContent>
        </Card>
      </div>
